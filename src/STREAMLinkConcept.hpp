...
public:
  ...
  STREAMLinkConcept(const STREAMLinkConcept&) = delete;            ///< STREAMLinkConcept is not copy-constructible
  STREAMLinkConcept& operator=(const STREAMLinkConcept&) = delete; ///< STREAMLinkConcept is not copy-assginable
  STREAMLinkConcept(STREAMLinkConcept&&) = delete;                 ///< STREAMLinkConcept is not move-constructible
  STREAMLinkConcept& operator=(STREAMLinkConcept&&) = delete;      ///< STREAMLinkConcept is not move-assignable
