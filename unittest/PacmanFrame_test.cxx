...
BOOST_AUTO_TEST_CASE(PacmanHeader_Methods)
{
  ...
  // Here we could test all the "get" functions, but for us they take a message as an argument... Perhaps write/take an
  // example message to cast? Message received: b'D\xb0D?a\x00\x01\x00D\x01\xd0\x1f%\x02\x00\x00/\x00@\x00\x00\x00\x00@'
  // //this is wrong - some get interpreted by python print() 0x44 0xb0 0x44 0x3f 0x61 0x0 0x1 0x0 0x44 0x1 0xd0 0x1f
  // 0x25 0x2 0x0 0x0 0x2f 0x0 0x40 0x0 0x0 0x0 0x0 0x40 //this is wrong - wrong order of bytes! to get 1631536304 the
  // order should be 0x61 0x3f 0x44 0xb0 in the timestamp trying to correct the order type ... timestamp ... empty word
  // count empty ... word type... word index ... word timestamp ... data (whatever) 0x44 ... 0x61 0x3f 0x44 0xb0 ... 0x0
  // 0x1 0x0 ... 0x44 ... 0x1 ... 0x2 0x25 0x1f 0xd0 ... 0x0 0x0 0x2f 0x40 0x40 0x0 0x0 0x0 0x0 0x40 Decoded as
  // (('DATA', 1631536304, 1), [('DATA', 1, 35987408, b'/\x00@\x00\x00\x00\x00@')])
